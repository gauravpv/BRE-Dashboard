...
public class AzureOAuthClientConfiguration {
    ...
    static final class AzureOAuthConfiguredCondition implements Condition {
        ...
        public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
            ...
            return StringUtils.hasText(env.getProperty("opsconsole.auth.azure.client-id"))
                    && StringUtils.hasText(env.getProperty("opsconsole.auth.azure.client-secret"))
                    && StringUtils.hasText(env.getProperty("opsconsole.auth.azure.tenant-id"));
        }
    }
}
